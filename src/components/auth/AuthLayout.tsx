      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center shadow-lg shadow-pink-500/25 transition-transform duration-300 group-hover:scale-110">
        ...
        {/* Card Content */}
        <div className="bg-white/5 border border-white/10 backdrop-blur-2xl backdrop-saturate-150 rounded-[2rem] p-8 md:p-10 shadow-2xl">
